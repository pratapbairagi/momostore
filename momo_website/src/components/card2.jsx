        ...
        <div className="flex" style={{ flexDirection: "column", padding: "0" }}>
            <div className="flex" style={{ flexDirection: "column" }}>
                ...
                <div className="scroll_btns" style={{ justifyContent:"center"}}>
                    ...
                    <span style={{ width: "2rem", height: "1rem", lineHeight:"0.7rem", backgroundColor: "#C82880", border: "2px solid white", boxShadow: " 0 0 0 1px #C82880", fontSize:"8px", textAlign:"center", color:"var(--bright-color-2)", fontWeight:"600" }}>
                        Half
                    </span>
